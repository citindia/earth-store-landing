...
const page = () => {
	return (
		<>
			<section className="bg-[url(/contact/contact-banner.jpg)] bg-center bg-cover py-64 grid place-items-center">
			...
			<section className="py-28 px-48 grid grid-cols-2 gap-4">
				...
				<div className="">
					<div className="text-4xl uppercase font-semibold">Talk To Us</div>
					...
					<div className="space-y-8 mt-8">
						<div className="flex gap-4 items-center">
							...
							<div className="">
								...
								<div className="text-2xl font-semibold text-earth-dark">
									something@tyler.com
								</div>
							</div>
						</div>
