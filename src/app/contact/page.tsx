  ...
  return (
    <>
      ...
      <section className="grid grid-cols-2 gap-36 px-56 py-28">
        ...
        <div className="">
          <div className="text-4xl font-semibold uppercase">Talk To Us</div>

          <div className="mt-8 space-y-8">
            <div className="flex items-center gap-4">
              <div className="border-earth-dark rounded-full border p-3">
                <MailIcon />
              </div>

              <div className="">
                <div className="text-lg">EMAIL</div>
                <div className="text-earth-dark text-2xl font-semibold">
                  something@tyler.com
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="">
                ...
                <div className="text-earth-dark text-2xl font-semibold">
                  202-555-01882727 Ocean Road, <br /> Malibu, CA, 90264
                </div>
              </div>
            </div>

            <div className="ms-16 space-y-4">
              <div className="text-earth-dark text-lg">Follow Us:</div>
